...
from .deadlock import compute_deadlock_cells, compute_simple_deadlock_zone, is_deadlocked_positions, is_frozen_deadlock_positions
from .grid import (
    Board,
    DIRECTIONS,
    Heading,
...
def solve_board(
    ...
    *,
    ...
    deadlock_cells: frozenset[Position] = frozenset()
...
def _is_deadlocked_dynamic(
    ...
    # Corner deadlock: both sides of one corner blocked
